...
Your task is to simulate a process that collects the numbers from the list in the order
from the smallest to the largest.

Each round goes through the list from left to right and collects a number
if it is the next number to be collected. The process ends when all numbers have been collected.
...
Implement the function find_rounds that takes the list as a parameter and
